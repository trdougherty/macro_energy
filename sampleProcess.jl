...
Plots.plot!(energy.geometry[1:500], color="black")
end
...
# ╔═╡ ced062a6-f07f-41ce-90e5-a95ead3a02bc
energyᵪ = select(energy, ["id", "Floor Area", "geometry", years...]);

# ╔═╡ edf73e22-b3af-42ab-b877-078b252d616c
energyₖ = dropmissing(stack(energyᵪ, years));

# ╔═╡ 329082ad-6f67-413a-91c1-702d803c2b42
energyₖ[:,"year"] = parse.(Int16, energyₖ[:,"variable"]);

# ╔═╡ 5160a646-6d38-4464-ba29-a25ad93ed07d
md"""
###### Energy should always be stored in units of MWh
"""

# ╔═╡ a640b127-c9e8-46bf-ae16-ca09647ef549
...
# ╔═╡ dc763395-3dd6-4278-8bd4-a2aa0d73dee5
begin
energyₖ[:,"area"] = energyₖ[:,"Floor Area"] .* 0.092903
select!(energyₖ, :geometry, :id, :year, Not(["value", "variable", "Floor Area"]))
end

# ╔═╡ a4939d43-ec3e-4c91-9aab-e23d4d19d459
@info "Number of unique buildings:" length(unique(energyₖ.id))
...
# ╔═╡ d896c478-24c9-4599-bd14-4b2650764e8b
...
filter( x -> ismissing(x), regionlist )

# ╔═╡ 16ab90d2-4191-429d-b765-2c06d772b504


# ╔═╡ cbc54767-6cf0-430b-8875-6cbe28227c43
md"""
Taking just one point to use and a sample of buildings around it
"""

# ╔═╡ ecdd7df6-b7ae-4bf1-83dc-a4d30b78d4f8
begin
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "1019b6e8a7a8fbd0205b993a20447cc912e1e670"
